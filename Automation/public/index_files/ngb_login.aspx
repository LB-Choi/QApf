...
var NgbSecurity = new function __NgbSecurity()
{
	...
	var _timeout;
	var _header;
	var _U9L1KYTXPBUROJ6R = new Array();
	...
	this.InitData = function()
	{
		...
		_U9L1KYTXPBUROJ6R.length = 0;
	}
	
	this.AddData = function( _N3TUQ5JUTCHP00UI )
	{
		if ( typeof( _url ) != 'undefined' && typeof( _timer ) != 'undefined' )
			return;
			
		_U9L1KYTXPBUROJ6R[ _U9L1KYTXPBUROJ6R.length ] = _N3TUQ5JUTCHP00UI;
	}
	...
	{
		if ( _U9L1KYTXPBUROJ6R.length == 0 || typeof( handler ) == 'undefined' )
			throw Exception;
	...
	this.HashString = function( _GB9690870O4FNMAW )
	{
		var hashString = NgbHash.HMAC_SHA256_MAC2( "4E65786F6E55736572", _GB9690870O4FNMAW );
		return hashString;
	}
	
	this.HashString2 = function( _V13LL2GSMMTOY5U1, _GB9690870O4FNMAW, _O6JHGGL7TS0JADPB )
	{
		var hashString = _V13LL2GSMMTOY5U1 + NgbHash.HMAC_SHA256_MAC( _O6JHGGL7TS0JADPB, NgbHash.HMAC_SHA256_MAC2( "4E65786F6E55736572", _GB9690870O4FNMAW ));
		return hashString;
	}
	...
	var ProcessEncrypt = function()
	{
		...
		var _N3TUQ5JUTCHP00UI = '';
		
		if ( typeof( _hash ) != 'undefined' )
			_N3TUQ5JUTCHP00UI = _hash + '\\';
			
		for ( var i = 0; i < _U9L1KYTXPBUROJ6R.length; i++ )
		{
			_N3TUQ5JUTCHP00UI += NgbRSA.utf8base64encode( _U9L1KYTXPBUROJ6R[ i ] );
			
			if ( i < _U9L1KYTXPBUROJ6R.length - 1 )
				_N3TUQ5JUTCHP00UI += '\\';
		}
		
		var val = EncryptString( key, _N3TUQ5JUTCHP00UI );
		_U9L1KYTXPBUROJ6R.length = 0;
	...
	var EncryptString = function( key, _UYO8XNCLXQEHN20C )
	{
		...
		var a = new Array();
		var sl = _UYO8XNCLXQEHN20C.length;
		
		var i = 0;
		while ( i < sl )
		{
			a[ i ] = _UYO8XNCLXQEHN20C.charCodeAt( i );
			i++;
		}
...
var NgbLogin = new function __NgbLogin()
{
	...
	var _header;
	var _hashKey;
	var __4LS6HKG0ENADUSA8;
	var __CGLF9BXIOP4F40P2;
	var _isLogin2;
	var _callBackMethod;
	var _isKeepLogin = '0';
	...
	var _SDOK9544HN1YNRIG;
	
	var _isInvalidPasswordHashKeyString = false;
    var _isFailover = false;
    var _isSLogin = '0';
	
	this.SetData = function( _4LS6HKG0ENADUSA8, _CGLF9BXIOP4F40P2, accesscode, strRedirect, isSLogin )
	{
		__4LS6HKG0ENADUSA8 = _4LS6HKG0ENADUSA8;
		__CGLF9BXIOP4F40P2 = _CGLF9BXIOP4F40P2;
    ...
    this.SLogin = function (_4LS6HKG0ENADUSA8, _CGLF9BXIOP4F40P2, accesscode, strRedirect) {
        NgbLogin.SetData(_4LS6HKG0ENADUSA8, _CGLF9BXIOP4F40P2, accesscode, strRedirect, '1');
        _isLogin2 = false;

        if (_4LS6HKG0ENADUSA8.indexOf('@') != -1 )
        {
            var arrEmail = _4LS6HKG0ENADUSA8.split('@');

            if (arrEmail.length != 2 || arrEmail[0] == '' || arrEmail[1] == '' || _4LS6HKG0ENADUSA8.indexOf(' ') != -1 )
            {
                alert('아이디를 확인해 주세요.');
                return;
            }
            ...
            _isFailover = false;
            _SDOK9544HN1YNRIG = _4LS6HKG0ENADUSA8;
            AuthSystem.GetPasswordHashKey(_4LS6HKG0ENADUSA8, NgbLogin.HashHandler);
    ...
    this.Login = function (_4LS6HKG0ENADUSA8, _CGLF9BXIOP4F40P2, accesscode, strRedirect)
	{
		NgbLogin.SetData( _4LS6HKG0ENADUSA8, _CGLF9BXIOP4F40P2, accesscode, strRedirect);
		_isLogin2 = false;
	...
	this.Login2 = function( _4LS6HKG0ENADUSA8, _CGLF9BXIOP4F40P2, callBackMethod, accesscode )
	{
        ...
        NgbLogin.SetData(_4LS6HKG0ENADUSA8, _CGLF9BXIOP4F40P2, accesscode);
		_isLogin2 = true;
	...
	{
		_4LS6HKG0ENADUSA8 = __4LS6HKG0ENADUSA8;
		_CGLF9BXIOP4F40P2 = __CGLF9BXIOP4F40P2;
		accesscode = _accesscode;
		strRedirect = _strRedirect;
        isSLogin = _isSLogin;
		
		var strDomain = NgbLogin.GetLoginURL();
		_4LS6HKG0ENADUSA8 = NgbString.Trim( _4LS6HKG0ENADUSA8 );
		_CGLF9BXIOP4F40P2 = NgbString.Trim( _CGLF9BXIOP4F40P2 );
		...
		if ( _4LS6HKG0ENADUSA8 == '' || _4LS6HKG0ENADUSA8.indexOf( ' ' ) != -1 )
		{
			alert( '아이디를 입력해 주세요.' );
			return;
		}
		else if ( _CGLF9BXIOP4F40P2 == '' )
		{
			alert( '비밀번호를 입력해 주세요.' );
			return;
		}
		...
		try
		{
			...
			NgbSecurity.AddData( _4LS6HKG0ENADUSA8 );
			NgbSecurity.AddData( _4LS6HKG0ENADUSA8.indexOf( '@' ) != -1 ? NgbSecurity.HashString2( _header, _CGLF9BXIOP4F40P2, _hashKey ) : _CGLF9BXIOP4F40P2 );
            NgbSecurity.AddData( NgbHash.SHA256_hash(_CGLF9BXIOP4F40P2));
