...
### 💡 Retrospective: 자동화와 AI 활용에 대한 소회
자동화는 수동 테스트를 완벽히 대체하는 것이 아닌, QA 엔지니어가 더 복잡하고 창의적인 결함 분석에 집중할 수 있도록 돕는 강력한 보조 도구입니다. 

이번 프로젝트에서 Mock HTML 코드와 페이지 구조 작성에 AI를 적극 활용함으로써 단순 스크립트 타이핑 시간을 단축했습니다. 덕분에 품질을 보증하기 위한 테스트 시나리오를 설계하는 **QA 본연의 품질 분석 업무**에 온전히 집중할 수 있었습니다.
