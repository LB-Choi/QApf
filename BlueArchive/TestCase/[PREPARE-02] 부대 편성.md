...
|:---:|---|---|---|:---:|
| 1 | [빠른 편성] 버튼 선택 | - | 보유 중인 학생 목록과 빠른 편성 UI 노출 | 🟢 Pass |
| 2 | 임의의 STRIKER 학생 선택 | STRIKER 편성에 빈 칸이 있는 상태 | 해당 학생의 기본 정보 노출 및 하단 STRIKER 편성에 추가 | 🟢 Pass |
...
| 6 | 임의의 SPECIAL 학생 선택 | SPECIAL 편성에 빈 칸이 있는 상태 | 해당 학생의 기본 정보 노출 및 하단 SPECIAL 편성에 추가 | 🟢 Pass |
| 7 | 2명의 SPECIAL가 편성된 상태에서 SPECIAL 학생 선택 | - | 해당 학생의 기본 정보 노출 | 🟢 Pass |
| 8 | [자동] 버튼 선택 | - | 추천 편성으로 자동 편성 | 🟢 Pass |
| 9 | [체크 표시된 카드] 이미지 버튼 선택 | - | 시작 스킬 선택 UI 모달 생성 | 🟢 Pass |
| 10 | [확인] 버튼 선택 | - | 편성창 내 학생 모델링 정상 노출 | 🟢 Pass |
